      ...
      <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form className="space-y-4 md:space-y-6" >
          <div>
            ...
            <input type="email" name="email" id="email" className="bg-gray-50  border border-emerald text-emerald rounded-lg focus:outline-2 focus:outline-offset-2 focus:outline-emerald  block w-full p-2.5   " placeholder="name@company.com"  />
          </div>
          <div>
            <label htmlFor="password" className="block mb-2 text-sm font-medium text-emerald ">Password</label>
            <input type="password" name="password" id="password" placeholder="••••••••" 
            className="bg-gray-50 border border-emerald text-emerald rounded-lg focus:outline-2 focus:outline-offset-2 focus:outline-emerald block w-full p-2.5"/>
          </div>
