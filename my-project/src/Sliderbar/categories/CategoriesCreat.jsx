...
const formik = useFormik({
    ...
    onSubmit :async (values, {resetForm})=>{
        ...
        const alpha =  await axios.post("http://localhost:4000/creatcategories",formData,{
            headers:{
    ...
    <div className=" bg-white w-full  rounded-lg border-2 border-slate-200 ">
        <div className="grid grid-cols-2 p-4 ">
            ...
            <div className="justify-self-end">
                <button  onClick={()=>{navigate('/admin/categories')}} className="bg-yellow-400 px-3 py-1 text-white border-none hover:bg-yellow-500 rounded text-right">
...
export default CategoriesCreat;