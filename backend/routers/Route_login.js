...
const {login,conformpassword,changeConformpassword, signup, signin, contactus, review, getReviews, cartitems, cartPrducts, deleteCart} = require('../controller/Control_Login');
